...
PairStyle(morse/lj/coul/dsf/gpu,PairMorseLJCoulDSFGPU)
...
class PairMorseLJCoulDSFGPU : public PairMorseLJCoulDSF {
 public:
  PairMorseLJCoulDSFGPU(LAMMPS *lmp);
  ~PairMorseLJCoulDSFGPU();
